...
if __name__ == "__main__":
    ...
    trained_models = ma_train(ma_env, model_algo_map=model_algo_map, models_to_train='truck_1',
                              total_timesteps_per_model=50_000, training_iterations=1,
                              tb_log_suffix=f"trajectory_optim")
    
    ma_env.close()

    trained_models['truck_1'].save('policies/test1')
    trained_models['truck_2'].save('policies/test2')
    ...
    model_agent_2 = agent_2_algo.load('policies/test2')
