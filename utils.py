from base import BaseMAEnv, AgentMAEnv
import tempfile
import os
import time
...
#                    # Entrenamiento del modelo en la cantidad de pasos de esta iteración
...
#                    # Inmediatamente después del entrenamiento, guarda el modelo actualizado
#                    save_temp_model(model, model_name, trained_model_filenames)#

#                    # Recarga el modelo actualizado para asegurarte de que el entorno tenga el último estado
#                    models[model_name] = load_temp_model(model_name, agent_env_map, model_algo_map, previous_model_filenames)
#                    ma_env.set_agent_models(models=models)  # Actualiza los modelos en el entorno       #

#            reset_timesteps = False  # No restablecer los timesteps después de la primera iteración#

#            # Al final de la iteración, recarga los modelos actualizados en el entorno
#            models = load_temp_models(agent_env_map, model_algo_map, trained_model_filenames)
#            ma_env.set_agent_models(models=models)      #

#            # Guarda los modelos al final de la iteración como los "modelos previos"
#            save_temp_models(models, previous_model_filenames)#
